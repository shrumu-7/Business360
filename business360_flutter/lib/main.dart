...
class _Business360AppState extends State<Business360App> {
  ...
  Color seedColor() {
    switch (theme) {
      ...
      case 'dark':
        return const Color(0xFF686FF0);
      default:
        return const Color(0xFF6C57F5);
    }
  }
...
class HomeScreen extends StatelessWidget {
  ...
  Widget page() {
    switch (index) {
      ...
      default:
        return DashboardPage(store: store, prefs: prefs);
    }
  }
  ...
  @override
  Widget build(BuildContext context) {
    final selected = index.clamp(0, 4).toInt();
...
class DashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final due = customers.fold<double>(
      0,
      (sum, customer) => sum + customer.due,
    );
    final stock = products.fold<double>(
      0,
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    prefs.getString('shop') ?? 'আমার দোকান',
                    style: const TextStyle(
                      fontSize: 26,
                      fontWeight: FontWeight.bold,
                    ),
                  ...
                  if ((prefs.getString('phone') ?? '').isNotEmpty)
