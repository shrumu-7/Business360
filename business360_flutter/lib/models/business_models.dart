...
class BusinessExpense {
  ...
  final String id; final DateTime date; final String title; final double amount; final String note;
...
class Purchase {
  ...
  final String id; final DateTime date; final String supplier; final double amount; final double paid; final String note;
